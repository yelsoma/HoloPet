...
1.遊戲物件
 ...
 Hierarchy上的物件(Botan,Cart,Chair...)都有各自的"狀態機"和"狀態"腳本。
...
上述的方法會在"狀態機"中有繼承"StateMachineBase"的Monobehaveir裡面運行
private void Start(){};
private void Update();
...
點擊滑鼠時，Hierarchy 上 GameControllCenter 中的 InputManagerCenter 會找到被點擊物件的 iClickable interface (例 "CartInputManager") 然後物件的 iClickable 就會直接幫物件轉換狀態。
